    ...
    <div style="border: 1px solid #ddd; padding: 20px;">
        ...
        <div class="mb-3">
            ...
            <form action="{{ url('/purchase/'.$product->id) }}" method="POST">
                ...
                @if($transaction)
                    <a href="{{ url('/download/'.$product->id) }}" style="padding: 10px 20px; background-color: blue; color: white; border: none; text-decoration: none;">Download</a>
                @else
                    <button type="submit" style="padding: 10px 20px; background-color: green; color: white; border: none;">Buy Now</button>
                @endif
            </form>
